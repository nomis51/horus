...
Copy-Item -Path ../src/WinPass/bin/Release/net7.0/runtimes/win10-x64/* -Force -Recurse -Destination ../build/runtimes/win10-x64
mkdir ../build/runtimes/win
Copy-Item -Path ../src/WinPass/bin/Release/net7.0/runtimes/win/lib/net7.0/* -Force -Recurse -Destination ../build/runtimes/win/lib/net7.0
mkdir ../build/ref
